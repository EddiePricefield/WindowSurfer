    ...
    if ( inimigo != NULL ) {
        switch ( inimigo->tipo ) {
            ...
            case TIPO_INIMIGO_ADWARE:
                ...
                break;
            case TIPO_INIMIGO_PONTEIRO:
                destruirInimigoPonteiro( (InimigoPonteiro*) inimigo->objeto );
                break;
...
void atualizarInimigo( Inimigo *inimigo, GameWorld *gw, float delta ) {
    ...
    switch ( inimigo->tipo ) {
        ...
        case TIPO_INIMIGO_ADWARE:
            ...
            break;
        case TIPO_INIMIGO_PONTEIRO:
            atualizarInimigoPonteiro( (InimigoPonteiro*) inimigo->objeto, gw, delta );
            break;
        case TIPO_INIMIGO_BOSS:
...
void desenharInimigo( Inimigo *inimigo ) {
    ...
    switch ( inimigo->tipo ) {
        ...
        case TIPO_INIMIGO_ADWARE:
            ...
            break;
        case TIPO_INIMIGO_PONTEIRO:
            desenharInimigoPonteiro( (InimigoPonteiro*) inimigo->objeto );
            break;
        case TIPO_INIMIGO_BOSS:
